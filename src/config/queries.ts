import { ValidatedQuery,
         ...
         ComponentLanguages,
         QueryType,
         OutputOptions} from "./interfaces";
import { DEFAULT_COMPONENT_STYLES, DEFAULT_COMPONENT_LANGUAGE, DEFAULT_COMPONENT_MODEL, DEFAULT_OUTPUT_OPTION } from "./components";
...
export const LANGUAGE_QUERY: ListQuery = {
    ...
    options: [
        ComponentLanguages.TypeScript,
        ComponentLanguages.JavaScript
    ],
...
export const TYPE_QUERY: ListQuery = {
    ...
    options: [
        ComponentModels.FunctionalComponent,
        ComponentModels.ClassComponent
    ],
...
export const OUTPUT_QUERY: ListQuery = {
    ...
    options: [
        OutputOptions.OpenOutputFolder,
        OutputOptions.SaveInsideCurrentFolder
    ],
    answer: DEFAULT_OUTPUT_OPTION
}

export const QUERIES: QueryType[] = [Object.create(NAME_QUERY), Object.create(LANGUAGE_QUERY), Object.create(TYPE_QUERY), Object.create(STYLE_QUERY), Object.create(OUTPUT_QUERY)];